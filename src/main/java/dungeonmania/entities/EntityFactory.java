...
import dungeonmania.entities.inventory.InventoryFactory;
...
public class EntityFactory {
    ...
    public EntityFactory(JSONObject config, InventoryFactory inventoryFactory) {
        this.config = config;
    ...
    public Player buildPlayer(Position pos) {
        ...
        InventoryInterface inventoryInterface = inventoryFactory.createInventory();
        return new Player(pos, playerHealth, playerAttack, inventoryInterface);
    }
    ...
    public Mercenary buildMercenary(Position pos) {
        ...
        return new Mercenary(pos, mercenaryHealth, mercenaryAttack, mercenaryBribeAmount, mercenaryBribeRadius,
                allyAttack, allyDefence, mindControlDuration);
    }
    ...
    public MidnightArmour buildMidnightArmour() {
        ...
        double defence = config.optInt("midNightArmourDefence");
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        case "wire":
            return new Wire(pos);
        case "light_bulb_off":
            return new LightBulb(pos, buildLogicRule(jsonEntity.optString("logic", "or")));
        case "sun_stone":
    ...
    public static LogicalRuleStrategy buildLogicRule(String logic) {
        switch (logic) {
        case "and":
