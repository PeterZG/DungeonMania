...
public class Player extends PassiveEntity implements Battleable {
    ...
    public Player(Position position, double health, double attack, InventoryInterface inventoryInterface) {
        super(position);
