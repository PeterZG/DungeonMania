...
public class DungeonManiaController {
    ...
    public DungeonResponse build(String buildable) throws IllegalArgumentException, InvalidActionException {
        ...
        if (buildable.equals("midnight_armour") && game.getEntityFactory().getHasZombile()) {
            throw new InvalidActionException("Unbuildable for midnight_armour because "
            + "there are zombies currently in the dungeon.");
        }
